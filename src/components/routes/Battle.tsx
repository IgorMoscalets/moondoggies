...
import moonDogBattle from "../../moondogbattle.png";

const CONTRACT_ADDRESS = "0x9A1158521a35032573BD96FBDeDbdd8867E74EF0";
export const Battle = () : React.ReactElement => {
	...
	const runContractFunction = async () => {
		...
		dataArray.forEach(async (dogId) => {
			...
			<div className="sellbutton"><button>Fight With</button></div>
			</div>);
...
return (
	<div id="Battle">
		Choose your Doggie to fight with: 
		<div id="cards-render" className="row">
			{elements}
		</div>
		<div className="moondogbattle"><img src={moonDogBattle} alt="" /></div>
	</div>
  );
}